...
func NewMerkle(suite abstract.Suite) *Merkle {
	merkle := &Merkle{}
...
func (merkle *Merkle) InitCommitCrypto() {
...
func (merkle *Merkle) MerkleAddChildren() {
...
// such
func (merkle *Merkle) MerkleAddLocal(localMTroot hashid.HashId) {
...
func (merkle *Merkle) MerkleHashLog() error {
	var err error
...
func (merkle *Merkle) ComputeCombinedMerkleRoot() {
...
func (merkle *Merkle) SeparateProofs(proofs []proof.Proof, leaves []hashid.HashId) {
...
func (merkle *Merkle) InitResponseCrypto() {
...
func (merkle *Merkle) StoreLocalMerkleProof(chm *ChallengeMessage) error {
...
func (merkle *Merkle) FillInWithDefaultMessages() []*SigningMessage {
...
func (merkle *Merkle) VerifyResponses() error {
...
func (merkle *Merkle) SendChildrenChallengesProofs(RoundNbr int, chm *ChallengeMessage) error {
...
func (merkle *Merkle) SendChildrenChallenges(chm *ChallengeMessage) error {
...
func (r *Merkle) Add(a abstract.Point, b abstract.Point) {
	if a == nil {
...
func (r *Merkle) Sub(a abstract.Point, b abstract.Point) {
	if a == nil {
		a = r.Suite.Point().Null()
	}
	if b != nil {
...
func (r *Merkle) IsRoot() bool {
	return r.Parent == ""
}

func (r *Merkle) IsLeaf() bool {
