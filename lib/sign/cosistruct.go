...
func (merkle *CosiStrut) InitCommitCrypto() {
...
func (merkle *CosiStrut) MerkleAddChildren() {
...
// such
func (merkle *CosiStrut) MerkleAddLocal(localMTroot hashid.HashId) {
...
func (merkle *CosiStrut) MerkleHashLog() error {
	var err error
...
func (merkle *CosiStrut) ComputeCombinedMerkleRoot() {
...
func (merkle *CosiStrut) SeparateProofs(proofs []proof.Proof, leaves []hashid.HashId) {
...
func (merkle *CosiStrut) InitResponseCrypto() {
...
func (merkle *CosiStrut) StoreLocalMerkleProof(chm *ChallengeMessage) error {
...
func (merkle *CosiStrut) VerifyResponses() error {
...
func (merkle *CosiStrut) SendChildrenChallenges(chm *ChallengeMessage) error {
...
func (r *CosiStrut) Add(a abstract.Point, b abstract.Point) {
	if a == nil {
...
func (r *CosiStrut) Sub(a abstract.Point, b abstract.Point) {
	if a == nil {
		a = r.Suite.Point().Null()
	}
	if b != nil {
...
func (r *CosiStrut) IsRoot() bool {
	return r.Parent == ""
}

func (r *CosiStrut) IsLeaf() bool {
