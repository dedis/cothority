...
// SearchTreeNode searches the Tree for the TreeNode corresponding to the given UUID and returns it
func (t *Tree) SearchTreeNode(tn uuid.UUID) (ret *TreeNode) {
...
// ListTreeNodes returns a list of TreeNodes generated by DFS-iterating the Tree
func (t *Tree) ListTreeNodes() (ret []*TreeNode) {
	ret = make([]*TreeNode, 0)
...
func (tm *TreeMarshal) MakeTreeFromList(parent *TreeNode, il *EntityList) *TreeNode {
	idx, ent := il.SearchEntity(tm.EntityId)
	tn := &TreeNode{
		Parent:    parent,
		Id:        tm.NodeId,
		Entity:    ent,
