...
import (
	...
	"github.com/dedis/cothority/lib"
...
func (id *Identity) Equal(i Identity) bool {
	return id.Public.Equal(i.Public)
}
...
func NewSecureTcpHost(private abstract.Secret, id Identity) *SecureTcpHost {
	return &SecureTcpHost{
		private:        private,
		Identity:       id,
		IdToAddr:       make(map[lib.UUID]string),
		TcpHost:        NewTcpHost(),
