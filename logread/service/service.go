...
type Storage struct {
	ACLs *skipchain.SBBStorage
	WLRs *skipchain.SBBStorage
}
...
func (s *Service) EvolveACL(req *logread.EvolveACLRequest) (reply *logread.EvolveACLReply,
	...
	reply.SB, cerr = skipchain.NewClient().BunchAddBlock(bunch, nil, req.NewAcls)
	if cerr != nil {
		return
	}
...
func (s *Service) WriteRequest(req *logread.WriteRequest) (reply *logread.WriteReply,
	...
	reply.SB, cerr = skipchain.NewClient().BunchAddBlock(wlrBunch, wlr.Roster, data)
	if cerr != nil {
		return
	}
...
func (s *Service) verifyACL(sb *skipchain.SkipBlock) bool {
...
func (s *Service) verifyWLR(sb *skipchain.SkipBlock) bool {
...
func newService(c *onet.Context) onet.Service {
	s := &Service{
		...
		Storage: &Storage{
			ACLs: skipchain.NewSBBStorage(),
			WLRs: skipchain.NewSBBStorage(),
		},
	}
	...
	service.RegisterVerification(c, logread.VerifyLogreadACL, s.verifyACL)
	service.RegisterVerification(c, logread.VerifyLogreadWLR, s.verifyWLR)
	var err error
