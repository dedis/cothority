...
import (
	...
	_ "go.dedis.ch/cothority/v4/authprox"
	_ "go.dedis.ch/cothority/v4/byzcoin"
	_ "go.dedis.ch/cothority/v4/byzcoin/contracts"
	_ "go.dedis.ch/cothority/v4/calypso"
	_ "go.dedis.ch/cothority/v4/eventlog"
	_ "go.dedis.ch/cothority/v4/evoting/service"
	_ "go.dedis.ch/cothority/v4/personhood"
	_ "go.dedis.ch/cothority/v4/skipchain"
