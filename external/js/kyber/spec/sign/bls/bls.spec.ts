...
describe("BLS Signature Tests", () => {
    ...
    const pub = "593c700babf825b6056a2339ce437f73f717226a77d618a5e8f0251c00273b38557c3cda8dbde5431d062804275f8757a" +
        "2c942d888ac09f2df34f806e35e660a3c6f13dc64a7cf112865807450ccbd9f75bb3aadb98599f7034cf377a9b976045df374f840" +
        "e9ee617631257fc9611def6c7c2e5cf23f5ab36cf72f68f14b6686";
    ...
    it("should sign the message and verify the signature", () => {
        ...
        expect(sig.toString("hex")).toBe("3bcac305c40c84155faa4c03899a2083cd601f6eb43ca7bd2e2b675311fd6fdc4295b573" +
            "f6725e47a94d77015c89d81b562f6eba2c2d3755e8ce390af56688ca");
    ...
    it("should pass the property-based check", () => {
        const prop = jsc.forall(jsc.string, jsc.array(jsc.nat), (msg, k) => {
            const scalar = new BN256Scalar(new BN(k));
            const point = new BN256G2Point(scalar.getValue());

            const sig = sign(message, scalar);
            return verify(message, point, sig);
        });
