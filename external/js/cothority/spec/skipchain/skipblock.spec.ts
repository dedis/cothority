import { SkipBlock, ForwardLink, ByzcoinSignature } from '../../src/skipchain/skipblock';
...
describe('SkipBlock Tests', () => {
    it('should hash the block', () => {
        ...
        expect(sb.computeHash().toString('hex')).toBe('698629e47b4736d7c4a0a75c42529e80e0d962eed2e7111b1616ab2ffaab22b5');
    });

    it('should hash the block with a roster', () => {
        const roster = new Roster({
            list: [
                new ServerIdentity({ public: Buffer.from('65642e706f696e7471e96e3fcf50e07c1937ffc3df479f3cd0d5e76f37471439fe556fdc768b225d', 'hex') }),
                new ServerIdentity({ public: Buffer.from('65642e706f696e74510f70f3655f26ec7289a1c23b3fcb258c6fceb546670e3d5fd63ec1020a9ee3', 'hex') }),
            ]
        });
        ...
        expect(sb.computeHash().toString('hex')).toBe('0905c7459d7bd011455160b6faa41d744268794a1733e9d3c45f988204352875');
    });
