package ch.epfl.dedis.lib.crypto.blake2s;

/*
  Source from bouncycastle: https://github.com/bcgit/bc-java/blob/master/core/src/main/java/org/bouncycastle/crypto/digests/Blake2sDigest.java

  The default implementation of bouncycastle doesn't support the Tree Hashing Mode parameters which
  are required for the XOF implementation. A PR has been open but in the mean time, a working
  implementation is put inside this package.

  PR: https://github.com/bcgit/bc-java/pull/503
  TODO: remove after the pull request is merged
 */
